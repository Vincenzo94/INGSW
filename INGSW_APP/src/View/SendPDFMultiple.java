...
public class SendPDFMultiple extends javax.swing.JFrame {
    ...
    /**
     * Creates new form SendPDFMultiple
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SendPDFMultiple.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SendPDFMultiple().setVisible(true);
            }
        });
    }
