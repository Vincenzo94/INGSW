...
public class Injuction_MYSQL implements DAO_Document{
    ...
    public Injuction_MYSQL(Database_Controller dbController) {
        this.dbController = dbController;
    }

    private Bill getReferredBill(Integer billID) throws SQLException{
        Bill bill;
        PreparedStatement statement = dbController.getStatement(QUERY_SEARCH_BILL_ID);
    ...
    List<Injuction> injuctions = new ArrayList<>();
        PreparedStatement statement = dbController.getStatement(QUERY_GET_ALL_INJUCTIONS);
    ...
    List<Injuction> injuctions = new ArrayList<>();
        PreparedStatement statement = dbController.getStatement(QUERY_GET_ALL_INJUCTIONS_CONTRACT);
    ...
    public void remove(Document document) throws SQLException{
        PreparedStatement statement = dbController.getStatement(QUERY_REMOVE);
